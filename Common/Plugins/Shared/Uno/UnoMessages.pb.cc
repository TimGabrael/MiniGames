...
PROTOBUF_CONSTEXPR ServerResync::ServerResync(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.sync_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct ServerResyncDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ServerResyncDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
  ~ServerResyncDefaultTypeInternal() {}
  union {
    ServerResync _instance;
  };
};

PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ServerResyncDefaultTypeInternal _ServerResync_default_instance_;
}  // namespace uno
...
const ::uint32_t TableStruct_UnoMessages_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    0,
    ~0u,
    PROTOBUF_FIELD_OFFSET(::uno::ServerPullCards, _impl_._has_bits_),
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::uno::ServerPullCards, _impl_.next_player_in_turn_),
    ...
    0,
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::uno::ServerResync, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ~0u,  // no _weak_field_map_
    ~0u,  // no _inlined_string_donated_
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::uno::ServerResync, _impl_.sync_),
};
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        ...
        { 34, 44, -1, sizeof(::uno::ServerPullCards)},
        { 46, 57, -1, sizeof(::uno::ServerPlayCard)},
        { 60, -1, -1, sizeof(::uno::ServerResync)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
    ...
    &::uno::_ServerResync_default_instance_._instance,
};
const char descriptor_table_protodef_UnoMessages_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ...
    ".uno.CardData\"L\n\017ServerPullCards\022\033\n\023next"
    "_player_in_turn\030\001 \002(\005\022\034\n\005pulls\030\002 \003(\0132\r.u"
    "no.PullData\"]\n\016ServerPlayCard\022\021\n\tclient_"
    "id\030\001 \002(\005\022\033\n\023next_player_in_turn\030\002 \002(\005\022\033\n"
    "\004card\030\003 \002(\0132\r.uno.CardData\"+\n\014ServerResy"
    "nc\022\033\n\004sync\030\001 \003(\0132\r.uno.PullData"
};
...
class ServerPullCards::_Internal {
 public:
  using HasBits = decltype(std::declval<ServerPullCards>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
    8 * PROTOBUF_FIELD_OFFSET(ServerPullCards, _impl_._has_bits_);
...
::uint8_t* ServerPullCards::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(1, this->_internal_next_player_in_turn(), target);
  }
...
void ServerPullCards::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if ((from._impl_._has_bits_[0] & 0x00000001u) != 0) {
    _this->_internal_set_next_player_in_turn(from._internal_next_player_in_turn());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void ServerPullCards::InternalSwap(ServerPullCards* other) {
  ...
  swap(_impl_.next_player_in_turn_, other->_impl_.next_player_in_turn_);
}
...
class ServerResync::_Internal {
 public:
};

ServerResync::ServerResync(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:uno.ServerResync)
}
ServerResync::ServerResync(const ServerResync& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  ServerResync* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.sync_){from._impl_.sync_}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:uno.ServerResync)
}

inline void ServerResync::SharedCtor(::_pb::Arena* arena) {
  (void)arena;
  new (&_impl_) Impl_{
      decltype(_impl_.sync_){arena}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}

ServerResync::~ServerResync() {
  // @@protoc_insertion_point(destructor:uno.ServerResync)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void ServerResync::SharedDtor() {
  GOOGLE_ABSL_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.sync_.~RepeatedPtrField();
}

void ServerResync::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void ServerResync::Clear() {
// @@protoc_insertion_point(message_clear_start:uno.ServerResync)
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* ServerResync::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_sync(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
::uint8_t* ServerResync::_InternalSerialize(
    ::uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {

  // @@protoc_insertion_point(serialize_to_array_start:uno.ServerResync)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  // repeated .uno.PullData sync = 1;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_sync_size()); i < n; i++) {
    const auto& repfield = this->_internal_sync(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
  ...
  // @@protoc_insertion_point(serialize_to_array_end:uno.ServerResync)
  return target;
}

::size_t ServerResync::ByteSizeLong() const {

// @@protoc_insertion_point(message_byte_size_start:uno.ServerResync)
  ::size_t total_size = 0;
  ...
  // repeated .uno.PullData sync = 1;
  total_size += 1UL * this->_internal_sync_size();
  for (const auto& msg : this->_impl_.sync_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ServerResync::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    ServerResync::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ServerResync::GetClassData() const { return &_class_data_; }


void ServerResync::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ServerResync*>(&to_msg);
  auto& from = static_cast<const ServerResync&>(from_msg);

  // @@protoc_insertion_point(class_specific_merge_from_start:uno.ServerResync)
  GOOGLE_ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void ServerResync::CopyFrom(const ServerResync& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:uno.ServerResync)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ServerResync::IsInitialized() const {
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(_impl_.sync_))
    return false;
  return true;
}

void ServerResync::InternalSwap(ServerResync* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.sync_.InternalSwap(&other->_impl_.sync_);
}

::PROTOBUF_NAMESPACE_ID::Metadata ServerResync::GetMetadata() const {
...
template<> PROTOBUF_NOINLINE ::uno::ServerResync*
Arena::CreateMaybeMessage< ::uno::ServerResync >(Arena* arena) {
  return Arena::CreateMessageInternal< ::uno::ServerResync >(arena);
}
