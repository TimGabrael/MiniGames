...
constexpr SERVER_ROOM_JOIN_INFO SERVER_ROOM_JOIN_INFO_MAX = ROOM_JOIN_NAME_COLLISION;
...
constexpr SERVER_ROOM_CREATE_INFO SERVER_ROOM_CREATE_INFO_MAX = ROOM_CREATE_COLLISION;
